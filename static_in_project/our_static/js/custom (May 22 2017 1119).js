...
$(document).ready(function() {
  ...
  $('.pannel').accordion({collapsible: true},{heightStyle: 'content'},{icons: {
   ...
   //END Scroll Top Script
    ...
    $('<div class="cage1-error-correct"><br /><br /><strong>Correct Errors when receiving from CPO</strong><hr class="form-divider"></div>').insertAfter('.cage1-correct-error-form #id_date_received_from_BE_by_cage1');

    cage1_correct_error = $('.cage1-correct-error-form #id_received_from_CPO_by_cage1, .cage1-correct-error-form #div_id_date_received_from_CPO_by_cage1, .cage1-correct-error-form #div_id_received_from_CPO_by_cage1, .cage1-correct-error-form #div_id_for_head_of_section')
    $(cage1_correct_error).slideUp()

    $('.cage1-error-correct').click(function(){
        $(cage1_correct_error).slideToggle()
    });
